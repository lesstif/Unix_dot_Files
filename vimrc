" novice's vimrc
" $Header: /export/home/novice/vimrc,v 1.1 1999-7-13 16:11:24+09 novice Exp $
...
" Abbreviations for some important numbers:
  iab YDesc /* <<ÇÁ·Î±×·¥ DESCRIPTION>> <C-J><C-J><Left> ÇÁ·Î±×·¥¸í : <C-J><Left>ÇÁ·Î±×·¥ ±¸ºÐ : <C-J> ÀÛ¼ºÀÚ : <C-J> ÇÁ·Î±×·¥ °³¿ä: <C-J> */ <Up><Up><Up><Up><Up><Up>
